...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"C:/Users/runneradmin/AppData/Local/Temp/build-env-3x7n_gxa/Scripts/python.exe",
        # Package versions
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"D:/a/contourpy/contourpy/.mesonpy-45if4ju_/lib/contourpy/util",
        source_dir=r"D:/a/contourpy/contourpy/lib/contourpy/util",
        cross_build="False",
        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=D:/a/contourpy/contourpy/.mesonpy-45if4ju_/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
